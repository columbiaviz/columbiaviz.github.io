...
- **Lateness**: Assignments: -25% missing writeup/submission, -20% incomplete submission/late submission (including missing submission resubmitted), -15% incomplete submission resubmitted. No exceptions unless you have a medical note. Quizzes: can be made up for full credit if we receive prior notice or subsequent medical note about your absence (contact IAs to make up quizzes). Other absences cannot be madeup.
