...
Submit this mini-assignment via [the application form](https://goo.gl/forms/EtidJPvitA7U6afi1) by **Monday 1/28, 11:59pm** to apply for enrollment in this class. You will be notified by Wed 1/30 of results.
...
Host your clock on the internet; since these files are static, an good method is to use [Github Pages](https://pages.github.com/) but you're welcome to use whatever is easiest for you.
...
Describe a little bit about yourself and why you want to take this class in [this application form](https://goo.gl/forms/EtidJPvitA7U6afi1).
