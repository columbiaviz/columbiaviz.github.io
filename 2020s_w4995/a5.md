...
Submit your proposal in the form of a [PDF file or Google Doc url]({{ layout.submissionform }}) for A5.1, by **Monday 3/30, 11:59pm**.
...
Submit your group's [PDF file or Google Slides url]({{ layout.submissionform }}) for A5.2, and your individual [peer assessments]({{ layout.peerassessform }}) for A5.1~5.2, by **Monday 4/6, 11:59pm**.
