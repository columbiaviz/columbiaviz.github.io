...
- **This class is always being updated and improved**. Our main coding platform [Observable](https://www.observablehq.com/) came out of beta just in 2019. This class, in its fourth iteration, is no longer in "beta" and feedback for last semester was good; however, we're constantly making improvements, so expect that you'll be asked for your feedback repeatedly. Your input will be shaping this class for future iterations.
