...
In this assignment, you will try out interfaces for data and text extraction.  Trifacta Wrangler is an interface that employs a programming-by-example interaction modality.    Instabase Refiner is an interface that ...
