...
2. V2: Create a visualization that compares the ratio of Likes-Dislikes in different categories. 
  * Hint: You'll need to [use data transforms](https://vega.github.io/vega-lite/docs/transform.html) to compute the ratios manually.  Watch out for divide by zeros! 
