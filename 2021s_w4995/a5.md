...
Submit your proposal in the form of a [PDF file or Google Doc url]({{ layout.submissionform }}) for A5.1, by **Monday 3/15, 11:59pm ET**.
...
Submit your group's [PDF file or Google Slides url]({{ layout.submissionform }}) for A5.2, and your individual [peer assessments]({{ layout.peerassessform }}) for A5.1~5.2, by **Monday 3/22, 11:59pm ET**.
...
Submit your group's [Google Slides url]({{ layout.submissionform}}) for Lightning Talk by **Monday 4/12, 11:59pm ET**.
...
Submit your group's (1) [final viz URL]({{ layout.submissionform }}) as A5.4, (2) your [writeup URL]({{ layout.submissionform }}), which may be the same as your viz, as A5.5, and finally (3) individually submit your [peer assessments]({{ layout.peerassessform }}) for A5.3~5.4, by **Monday 4/19, 11:59pm ET**.
