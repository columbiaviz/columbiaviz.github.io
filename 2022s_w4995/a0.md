...
Submit this mini-assignment via [the application form](https://forms.gle/WiVrXP2MjSwXGRmW8) by **Monday 1/24, 11:59pm ET** to apply for enrollment in this class. You will be notified by Thursday 1/27 of results.
...
Describe a little bit about yourself and why you want to take this class in [this application form](https://forms.gle/WiVrXP2MjSwXGRmW8).
