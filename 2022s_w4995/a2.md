...
Pick one representative team member to submit your [group report]({{ layout.submissionform }}), and then each person submit your [individual peer assessments]({{ layout.peerassessform }}) for A2, by **Monday 1/25, 11:59pm ET**.
