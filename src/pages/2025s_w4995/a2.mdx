...
Pick one representative team member to submit your <a href={links.forms.submit}>group report</a>, and then each person submit your <a href={links.forms.peer}>individual peer assessments</a> for A2, by **{frontmatter.due}**.
...
Dataset: [CSV](/files/data/nyc_census_by_boro_2000-2010.csv)
...
- Originality in visual concept (i.e., your visualization should not be from a template.)
