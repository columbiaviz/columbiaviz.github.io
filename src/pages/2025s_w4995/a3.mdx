...
After selecting a topic and dataset—but prior to analysis—you should write down an initial set of at least three questions you'd like to investigate. Prepare the data (i.e. do any cleaning you need), make 1 chart in Tableau, and post it to class #participation Slack by **{frontmatter.due.week1}**.
