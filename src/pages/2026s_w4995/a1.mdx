...
import {Content as Practitioners} from '../../resources/Practitioners.md';


<a href={links.sparks_signup}>Schedule / Sign-up Sheet</a>
...
Submit your group's presentation (google slides or PDF only) through the <a href={links.forms.submit}>assignment form</a> and individually, your <a href={links.forms.peer}>peer assessments</a> by **{frontmatter.due}** the day before your scheduled time to present.
