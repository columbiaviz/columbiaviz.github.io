...
groups: https://docs.google.com/spreadsheets/d/1ek7B694fNEsUMUQyXtAIjsuVkUtBvdDOUMRy8qMLk0o/edit?gid=0#gid=0
due:
  week1: "2/26"
  week2: "3/5"
  week3: "Wednesday 3/25, 11:59pm ET"
---
import {course, links} from "./_details.yml"
import {Content as D3} from '../../resources/D3.md';

<p><a href={frontmatter.groups}>Sign-up form</a></p>
...
Week 1 check-in: have your static Observable URL handy and each team member should be ready individually to discuss their project in class on {frontmatter.due.week1}.

Week 2 check-in: have your dynamic Observable URL handy and ready to discuss in class on {frontmatter.due.week2}.

Final submission: <a href={links.forms.submit}>Submit</a> your group's Observable url and individually, your <a href={links.forms.peer}>peer assessments</a> for A4, by **{frontmatter.due.week3}**.
...
By the end of the first week you should have a static D3 visualization in Observable, loading a near-final version of your dataset for this assignment. Have this ready for in-class critique on {frontmatter.due.week1}.
...
Your final deliverable should be one interactive visual that captures your main data finding. If you built supplementary visualizations, include them as part of your writeup in the 3rd week, but if you're deciding between showing a different view of the data through interactivity vs. through making a separate visual, choose interactivity.
