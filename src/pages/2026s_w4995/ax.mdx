...
When complete, <a href={links.forms.submit}>submit</a> via the usual Assignment Submission form (choose "Extra Credit" in the dropdown) by **{frontmatter.due}** at the latest.
