...
<CourseHeader title="Introduction to Data Visualization" subtitle={`COMS ${course.section} (3 pts)`}>
    ...
    _TAs:_ Max (hz2995; [Tue 3:30–5:30pm](https://calendar.app.google/e8iZEgLYbmFV53ST6)) & Wilson (wz2628; [Wed 11am–1pm](https://calendar.google.com/calendar/u/0/appointments/schedules/AcZssZ2IofL8qTiQdrR6FMgrpssxzfYGcF7cOQDcCGhAH-OaWDEiCGMvaw8dr_4nfZ08mzPKw9utP0Lp))<br />
