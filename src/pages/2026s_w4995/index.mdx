...
due: "Sunday, Jan. 4th (by 11:59pm ET)"
---
...
Start by reading the assignment details below. Once you've completed your visualization, submit a link to the URL where it can be viewed using this <a href={links.forms.clock}>application form</a>. Submissions are now being evaluated (and students added to the course) on a rolling, first-come-first-served basis.

Note that there are usually a number of spaces that open up in the early days of the semester. So even if you're still on the waitlist as of the first day of class, consider attending lecture anyway—there may ultimately be a space for you.
